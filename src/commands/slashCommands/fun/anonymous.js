...
module.exports = class prefixCommand extends Command {
    constructor(client) {
        super(client, {
            name: 'anonymous',
            usage: 'anonymous',
            description: 'Post an anonymous message in current channel. COST: 50 points',
    ...
    async run(interaction, args) {
        ...
        if (!points || points < cost) return interaction.reply({
            content: `**You need ${cost - points} more points to send an anonymous message in this server.**\n\nTo check your points, type \`${prefix}points\``,
            ephemeral: true
        })
