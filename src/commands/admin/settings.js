...
module.exports = class SettingsCommand extends Command {
  ...
  run(message, args) {
    ...
    embed
      ...
      .addField('Invite Me', '[Click Here](https://discord.com/api/oauth2/authorize?client_id=842244538248593439&permissions=8&scope=bot%20applications.commands)', true);
