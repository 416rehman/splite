...
module.exports = class SetFarewellMessageCommand extends Command {
   constructor(client) {
      ...
      `,
         ...
         examples: [
            "setfarewellmessage ?member has left the server.",
            "clearfarewellmessage",
         ],
      });
   }
   ...
   run(message, args) {
      const {
         ...
         farewell_message: oldFarewellMessage,
      ...
      message.client.db.settings.updateFarewellMessage.run(
         farewellMessage,
         message.guild.id
      );
      ...
      embed.setDescription(
         `The \`farewell message\` was successfully updated. ${success}\nUse \`clearfarewellmessage\` to clear the current \`farewell message\`.`
      );
      ...
      message.channel.send({
         embeds: [
            embed
               ...
               .addField(
                  "Message",
                  message.client.utils.replaceKeywords(farewellMessage)
               ),
         ],
      });
   }
