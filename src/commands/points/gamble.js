...
module.exports = class gambleCommand extends Command {
  ...
  async run(message, args) {
      ...
      const embed = new MessageEmbed()
          ...
          .setFooter(`Your points: ${points}. ${modifier ? `+10% Odds Perk Active.`: ''}`, message.author.displayAvatarURL({dynamic: true}))
          ...
          setTimeout(async () => {
              ...
              if (outcome === "lose") {
                  const embed = new MessageEmbed()
                      ...
                      .setFooter(`Your points: ${points - amount}. ${modifier ? `+10% Odds Perk Active.`: ''}`, message.author.displayAvatarURL({dynamic: true}))
