...
module.exports = class betCommand extends Command {
  ...
  run(message, args) {
    ...
    try {
      message.channel.send({content: `${member}, ${message.author.username} has sent you a bet of ${amount} points ${emojis.point}. Do you accept?`, components: [row]}).then(async msg => {
