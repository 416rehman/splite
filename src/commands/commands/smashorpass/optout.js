        ...
        collector.on('collect', async b => {
          ...
          if (b.customId === 'proceed') {
            ...
            msg.edit({embeds: [new MessageEmbed()
                  ...
                  .setFooter(`To opt back in, use this command again`)], components: []})
          }
          else {
            this.done(message.author.id)
            msg.edit({ components: [], embeds: [new MessageEmbed().setTitle('Opt-Out Smash Or Pass')
        ...
        collector.on('collect', async b => {
          ...
          if (b.customId === 'proceed') {
            ...
            msg.edit({embeds: [new MessageEmbed()
                  ...
                  .setFooter(`To opt back out, use this command again`)], components: []})
          } else {
            this.done(message.author.id)
            msg.edit({ components: [], embeds: [new MessageEmbed().setTitle('Opt-In Smash Or Pass')
