module.exports = async (client) => {
   ...
   for (const guild of client.guilds.cache.values()) {
      client
         ...
         .then(async () => {
             ...
             * ------------------------------------------------------------------------------------------------ */
            console.log(
               `Servers Cached \r[${"=".repeat(
                  Math.floor((i / client.guilds.cache.size) * 50)
               )}${" ".repeat(
                  50 - Math.floor((i / client.guilds.cache.size) * 50)
   ...
   client.logger.info(
      `${client.name} is running on ${client.guilds.cache.size} server(s)`
   );
};
